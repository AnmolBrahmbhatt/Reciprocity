...
error_reporting(E_ALL);
    ...
    if(isset($_POST['purchase'])){
        $cid = getCustomerId($_SESSION['email'],$_SESSION['customername'],$_SESSION['address'],$_SESSION['city'],$_SESSION['zip_code'],$_SESSION['country']);
        insertIntoOrder($conn,$cid,$_SESSION['total_price'],$_SESSION['customername'],$_SESSION['address'],$_SESSION['city'],$_SESSION['zip_code'],$_SESSION['country']);
...
?>
	...
	<form method="post" action="" class="form-horizontal" style="background-color: #ebdef0; border-radius:10px;">
